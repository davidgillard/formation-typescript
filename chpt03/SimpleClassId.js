 ...
 *
*/
var SimpleClassId = /** @class */ (function () {
    function SimpleClassId() {
    }
    SimpleClassId.prototype.print = function () {
        console.log("SimpleClassId = ".concat(this.id));
    };
...
var mySimpleClassId = new SimpleClassId();
