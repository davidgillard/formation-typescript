...
// Cette erreur se produit lorsque nous tentons d'attribuer une valeur à la propriété name dans la fonction membre setNameValue. Comme le montre cette erreur, nous ne
// pouvons définir une valeur pour une propriété en lecture seule que dans la fonction constructeur de classe. Notez que readonly peut également être utilisé dans les
// définitions d'interface et qu'il est également exclu du JavaScript généré.
